...
/* 대학소재지 */
if g141area=1 then college_area=11; * 서울;
if g141area=2 then college_area=21; * 부산;
if g141area=3 then college_area=22; * 대구;
if g141area=4 then college_area=25; * 대전;
if g141area=5 then college_area=23; * 인천;
if g141area=6 then college_area=24; * 광주;
if g141area=7 then college_area=26; * 울산;
if g141area=8 then college_area=31; * 경기;
if g141area=9 then college_area=32; * 강원;
if g141area=10 then college_area=33; * 충북;
if g141area=11 then college_area=34; * 충남;
if g141area=12 then college_area=35; * 전북;
if g141area=13 then college_area=36; * 전남;
if g141area=14 then college_area=37; * 경북;
if g141area=15 then college_area=38; * 경남;
if g141area=16 then college_area=39; * 제주;
if g141area=17 then college_area=29; * 세종;

/* 고교소재지 */
if g141f006=1 then high_area=11; * 서울;
if g141f006=2 then high_area=21; * 부산;
if g141f006=3 then high_area=22; * 대구;
if g141f006=4 then high_area=25; * 대전;
if g141f006=5 then high_area=23; * 인천;
if g141f006=6 then high_area=24; * 광주;
if g141f006=7 then high_area=26; * 울산;
if g141f006=8 then high_area=31; * 경기;
if g141f006=9 then high_area=32; * 강원;
if g141f006=10 then high_area=33; * 충북;
if g141f006=11 then high_area=34; * 충남;
if g141f006=12 then high_area=35; * 전북;
if g141f006=13 then high_area=36; * 전남;
if g141f006=14 then high_area=37; * 경북;
if g141f006=15 then high_area=38; * 경남;
if g141f006=16 then high_area=39; * 제주;
if g141f006=17 then high_area=29; * 세종;

/* 첫직장 위치: 현직장=첫직장이면 A파트, 이직자면 D파트 */
if g141a388=1 then first_sido = g141a014;  * 현 직장이 첫 직장;
else               first_sido = g141d020;  * 이직자: D파트 첫 직장;
...
gender=0;
if g141sex=1 then gender=1; * 남성;

age=2015-g141birthy; *연령;
...
edu=0;
if g141school in (2 3 ) then edu=1; *교육대+4년제, 전문대는 edu=0;

major=0;
if g141majorcat in (4 5) then major=1; * 자연+공학 전공;

marry=0;
if g141p001=2 then marry=1; * 기혼;

/* 첫직장 산업: 현직장=첫직장이면 A파트, 이직자면 D파트 */
if g141a388=1 then first_ind = g141a004_10;   * 현 직장이 첫 직장;
else               first_ind = g141d007_10;   * 이직자: D파트 첫 직장 산업;
...
/* 첫 직장 종사상 지위 */
if g141a388=1 then first_status=g141a021;       /* 현재 직장이 첫 직장 */
else if g141a388=2 then first_status=g141d023;  /* 이직자의 첫 직장 */
...
if g141f073=1 then gpa=g141f074/4; * 4점 만점;
if g141f073=2 then gpa=g141f074/4.3; * 4.3점 만점;
if g141f073=3 then gpa=g141f074/4.5; * 4.5점 만점;
if g141f073 in (. -1) then delete;

p_asset=g141p036; * 부모 자산;
p_inc=g141p035; * 부모소득;

wt=g141wt; * 가중치;

keep age gender marry edu job wt c_area college_area high_area major ac g141p001 g141 gpa p_asset p_inc g141f073;
run;
...
/* ============================================================
   ...
   - 2015년 선택모형에는 2014년 residual 사용
   ============================================================ */
...
/* ============================================================
   ...
   - 근무지: c48 기준 16개 시도권 재코딩
   - 출생지: c16 기준 16개 시도권 재코딩
...
data job15;
    merge d15(in=a) wage_wide(in=b) resid_wide(in=c);
    by ac job;
